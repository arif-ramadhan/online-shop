...
<body>
	...
	if(isset($_POST['simpan'])){
		...
		if($name_p != ''){
			...
			$update = mysqli_query($conn, "UPDATE produk SET nama_produk = '".$nama."',foto_produk = '".$name_p."',harga = '".$harga."'
		...
		if($update){
			...
			$update = mysqli_query($conn, "UPDATE produk SET nama_produk = '".$nama."',harga = '".$harga."'
			WHERE id_produk = '".$_GET['id']."'
			");
			if($update){
			echo '<script>
